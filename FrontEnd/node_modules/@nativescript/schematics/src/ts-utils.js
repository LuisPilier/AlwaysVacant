...
exports.getCompilerOptions = exports.getSourceFile = exports.replaceTextInNode = exports.updateNodeText = exports.findImportPath = exports.findMatchingNodes = exports.findNode = exports.insertBeforeFirstOccurence = exports.removeImport = exports.removeMetadataArrayValue = exports.getDecoratorMetadataFromClass = exports.getDecoratedClasses = exports.getDecoratedClass = exports.filterByChildNode = exports.collectDeepNodes = exports.addBootstrapToNgModule = exports.getNodesToRemoveFromNestedArray = exports.findMetadataValueInArray = exports.findImports = exports.findFullImports = exports.getSymbolsToAddToObject = void 0;
...
function getSymbolsToAddToObject(path, node, metadataField, symbolName) {
    ...
    if (matchingProperties.length === 0) {
        ...
        return [new change_1.InsertChange(path, pos, textToInsert)];
    }
...
function addBootstrapToNgModule(modulePath, rootComponentName) {
    return (host) => {
        ...
        const importChanges = ast_utils_1.addImportToModule(source, modulePath, 'NativeScriptModule', '@nativescript/angular');
...
exports.getDecoratedClasses = (tree, filePath, decoratorName) => {
    const moduleSource = exports.getSourceFile(tree, filePath);
...
exports.removeMetadataArrayValue = (tree, filePath, property, value) => {
    const source = exports.getSourceFile(tree, filePath);
...
function getCompilerOptions(tree, tsConfigPath) {
...
function parseTsConfigFile(tree, tsConfigPath) {
    const config = utils_1.getJsonFile(tree, tsConfigPath);
    const host = {
        useCaseSensitiveFileNames: ts.sys.useCaseSensitiveFileNames,
        readDirectory: ts.sys.readDirectory,
        fileExists: (file) => tree.exists(file),
        readFile: (file) => utils_1.getFileContents(tree, file),
    };
    const basePath = path_1.dirname(tsConfigPath);
