...
function default_1(options) {
    ...
    return schematics_1.chain([
        (tree) => {
            ...
            const projectObject = angular_project_parser_1.getProjectObject(tree, options.project);
        ...
        () => schematics_1.externalSchematic('@schematics/angular', 'component', utils_1.removeNsSchemaOptions(Object.assign(Object.assign({}, options), { skipImport: true }))),
        (tree) => {
        ...
        () => {
            if (!(platformUse.webOnly || platformUse.nsOnly)) {
                return schematics_1.schematic('convert-relative-imports', options);
            }
            else {
